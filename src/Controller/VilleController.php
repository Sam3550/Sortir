...
{
    #[Route(path: '/', name: 'app_ville_index', methods: ['GET'])]
    ...
    #[Route(path: '/new', name: 'app_ville_new', methods: ['GET', 'POST'])]
    ...
    #[Route(path: '/{id}/edit', name: 'app_ville_edit', methods: ['GET', 'POST'])]
    ...
    #[Route(path: '/{id}', name: 'app_ville_delete', methods: ['POST'])]
